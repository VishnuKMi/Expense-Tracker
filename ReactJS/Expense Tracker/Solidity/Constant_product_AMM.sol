...
contract CPAMM {
    ...
    mapping(address => uint) public balanceOf; //for shares
    ...
    function _update(uint _reserve0, uint _reserv1) private {
        reserve0 = _reserve0;
        reserve1 = _reserv1;
    }
    ...
    function swap(address _tokenIn, uint _amountIn) external returns (uint amountOut) {
        ...
        require(_amountIn > 0, "add funds to swap!");
    ...
    function addLiquidity(uint _amount0, uint _amount1) external returns (uint shares) {
        ...
        */
        if (reserve0 > 0 || reserve1 > 0) {
            require(reserve0 * _amount1 == reserve1 * _amount0, "product req (dy/dx = y/x) failed!");
        }
    ...
    function removeLiquidity(uint _shares) external returns (uint amount0, uint amount1) {
        ...
        */
        ...
        require(amount0 > 0 && amount1 > 0, "add liq to remove!");
